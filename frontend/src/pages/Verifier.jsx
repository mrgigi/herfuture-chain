            ...
            <div className="w-full max-w-lg z-10">
                ...
                <div className="glass-panel p-10 rounded-3xl relative overflow-hidden backdrop-blur-xl border border-slate-700/50 shadow-2xl">
                    ...
                    <form onSubmit={handleVerify} className="space-y-6">
                        ...
                        >
                            {status === 'loading' ? 'Querying Blockchain...' : <>Verify on <span className="text-white">Network</span></>}
                        </button>
                    </form>
                    ...
                    {status === 'error' && (
                        <div className="mt-8 p-6 bg-red-950/30 border border-red-500/30 rounded-2xl text-center fade-in-up">
                            ...
                            <p className="text-red-200/70 text-sm">This credential ID was not found on the <span className="text-white">Secure Network</span>. It may be invalid or incorrectly typed.</p>
                        </div>
                    )}
                </div>
